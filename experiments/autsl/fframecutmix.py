model = dict(
    ...
    cls_head=dict(
        ...
        dropout_ratio=0.5,
        init_std=0.01),
    # train_cfg=dict(blending=dict(type='FrameCutMix', num_classes=226, num_frames=32, alpha=1)),
    train_cfg=dict(blending=dict(type='FloatFrameCutmix', num_classes=226, num_frames=32, alpha=1)),
    # train_cfg=dict(blending=dict(type='Scrambmix', num_classes=226, num_frames=32, alpha=2)),
    # train_cfg=dict(blending=dict(type='CutmixBlending', num_classes=226, alpha=1)),
    # train_cfg =dict(type='MixupBlending', alpha=0.8, num_classes=226),
    # train_cfg = None,
