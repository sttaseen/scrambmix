model = dict(
    ...
    cls_head=dict(
        ...
        dropout_ratio=0.68,
        init_std=0.01),
    train_cfg=dict(blending=dict(type='CutmixBlending', num_classes=52, alpha=9.512)),
...
log_config = dict(interval=10,
                 hooks=[
                        ...
                        init_kwargs={
                         'entity': "cares",
                         'project': "hmdb51-cv",
                         'group': f'cutmix-fold{fold}',
                         'name': f'cutmix-fold-{fold}'
                        },
                        log_artifact=True)
])
...
lr_config = None
total_epochs = 60
work_dir = f'./work_dirs/cutmix-{fold}/'
