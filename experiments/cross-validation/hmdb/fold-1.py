...
ann_file_train = 'data/hmdb51/annotation_train_fold_1.txt'
ann_file_val = 'data/hmdb51/annotation_test_fold_1.txt'
ann_file_test = 'data/hmdb51/annotation_test_fold_1.txt'
img_norm_cfg = dict(
...
lr_config = None
total_epochs = 60
work_dir = './work_dirs/floatframecutmix-1/'
