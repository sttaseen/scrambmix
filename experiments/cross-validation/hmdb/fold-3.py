...
ann_file_train = 'data/hmdb51/annotation_train_fold_3.txt'
ann_file_val = 'data/hmdb51/annotation_test_fold_3.txt'
ann_file_test = 'data/hmdb51/annotation_test_fold_3.txt'
img_norm_cfg = dict(
