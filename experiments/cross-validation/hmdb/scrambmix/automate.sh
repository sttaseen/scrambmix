...
# python mmaction2/tools/train.py experiments/cross-validation/hmdb/scrambmix/fold-1.py --validate --deterministic --seed 0
# python mmaction2/tools/train.py experiments/cross-validation/hmdb/scrambmix/fold-2.py --validate --deterministic --seed 0
