model = dict(
    ...
    backbone=dict(
        type='ResNet3dCSN',
        pretrained2d=False,
        pretrained='work_dirs/alpha=0.5/latest.pth',
        depth=50,
        with_pool2=False,
        bottleneck_mode='ir',
        norm_eval=True,
    ...
    cls_head=dict(
        ...
        dropout_ratio=0.5,
        init_std=0.01),
    train_cfg=dict(blending=dict(type='Scrambmix', num_classes=226, num_frames=32, alpha=0.5)),
...
lr_config = dict(
    ...
    # warmup_iters=16)
total_epochs =50
work_dir = './work_dirs/alpha=0.5-1/'
