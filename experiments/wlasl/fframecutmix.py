model = dict(
    ...
    cls_head=dict(
        ...
        dropout_ratio=0.5,
        init_std=0.01),
    # train_cfg=dict(blending=dict(type='FrameCutMix', num_classes=100, num_frames=32, alpha=1)),
    train_cfg=dict(blending=dict(type='FloatFrameCutmix', num_classes=100, num_frames=32, alpha=1)),
